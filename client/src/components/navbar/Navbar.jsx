    ...
    return ( 
        <nav className="z-50 w-screen px-4 bg-white centered">
            <section className="w-4/5 h-20 spaced text-grayblue ">
                ...
                <ul className="spaced mobile:hidden lg:flex ">
                ...
                <button className="navbar-button mobile:hidden lg:block">request invite</button>
                <div className="w-10 h-5 bg-cover mobile:visible lg:hidden bg-img bg-menu-icon" onClick={toggleMenu}/>
