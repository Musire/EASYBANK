...
const Hero = () => {
    ...
    return ( 
        <div className="w-screen md:h-80vh desktop:h-screen mobile:min-h-screen mobile:h-auto bg-lightgray text-grayblue mobile:centered-col md:flex-row md:items-start">
            ...
            <div className="mobile:hidden md:block w-1/2 md:h-full overflow-y-visible flex justify-end bg-no-repeat bg-hero-desktop bg-[length:65rem_50rem] bg-[left_-2.5rem_top_-10rem] relative z-[1]">
                <img src={phones} alt="" className=" w-[768px] h-[960px] absolute md:-top-16 md:-right-16 lg:-top-20 lg:-right-20  desktop:-top-32 desktop:-right-28"/>
            </div>
        </div>
     );
}
